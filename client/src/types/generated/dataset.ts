...
export const getGetDatasetsQueryOptions = <TData = Awaited<ReturnType<typeof getDatasets>>, TError = ErrorType<Error>>(params?: GetDatasetsParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getDatasets>>, TError, TData>, }
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetDatasetsQueryKey(params);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getDatasets>>> = ({ signal }) => getDatasets(params, signal);
...
export const getPostDatasetsMutationOptions = <TError = ErrorType<Error>,
    ...
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postDatasets>>, TError,{data: DatasetRequest}, TContext>, }
...
export const getGetDatasetsIdQueryKey = (id: number,
    params?: GetDatasetsIdParams,) => [`/datasets/${id}`, ...(params ? [params]: [])] as const;
  

    
export const getGetDatasetsIdQueryOptions = <TData = Awaited<ReturnType<typeof getDatasetsId>>, TError = ErrorType<Error>>(id: number,
    params?: GetDatasetsIdParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getDatasetsId>>, TError, TData>, }
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetDatasetsIdQueryKey(id,params);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getDatasetsId>>> = ({ signal }) => getDatasetsId(id,params, signal);
...
export const getPutDatasetsIdMutationOptions = <TError = ErrorType<Error>,
    ...
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof putDatasetsId>>, TError,{id: number;data: DatasetRequest}, TContext>, }
...
export const getDeleteDatasetsIdMutationOptions = <TError = ErrorType<Error>,
    ...
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteDatasetsId>>, TError,{id: number}, TContext>, }
