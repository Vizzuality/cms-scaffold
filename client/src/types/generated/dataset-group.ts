...
export const getDatasetGroups = (
 ...
 signal?: AbortSignal
      ...
      return API<DatasetGroupListResponse>(
      {url: `/dataset-groups`, method: 'get',
        params, signal
    },
      );
    }
...
export const getGetDatasetGroupsQueryOptions = <TData = Awaited<ReturnType<typeof getDatasetGroups>>, TError = ErrorType<Error>>(params?: GetDatasetGroupsParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getDatasetGroups>>, TError, TData>, }
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetDatasetGroupsQueryKey(params);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getDatasetGroups>>> = ({ signal }) => getDatasetGroups(params, signal);
...
export const useGetDatasetGroups = <TData = Awaited<ReturnType<typeof getDatasetGroups>>, TError = ErrorType<Error>>(
 params?: GetDatasetGroupsParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getDatasetGroups>>, TError, TData>, }
...
export const postDatasetGroups = (
    datasetGroupRequest: DatasetGroupRequest,
      ...
      {url: `/dataset-groups`, method: 'post',
...
export const getPostDatasetGroupsMutationOptions = <TError = ErrorType<Error>,
    
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof postDatasetGroups>>, TError,{data: DatasetGroupRequest}, TContext>, }
 ...
 const {mutation: mutationOptions} = options ?? {};
   ...
   return  { mutationFn, ...mutationOptions }}
    ...
    export const usePostDatasetGroups = <TError = ErrorType<Error>,
 ...
 signal?: AbortSignal
      ...
      return API<DatasetGroupResponse>(
      {url: `/dataset-groups/${id}`, method: 'get',
        params, signal
    },
      );
    }
...
export const getGetDatasetGroupsIdQueryKey = (id: number,
    params?: GetDatasetGroupsIdParams,) => [`/dataset-groups/${id}`, ...(params ? [params]: [])] as const;
  

    
export const getGetDatasetGroupsIdQueryOptions = <TData = Awaited<ReturnType<typeof getDatasetGroupsId>>, TError = ErrorType<Error>>(id: number,
    params?: GetDatasetGroupsIdParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getDatasetGroupsId>>, TError, TData>, }
...
const {query: queryOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetDatasetGroupsIdQueryKey(id,params);
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getDatasetGroupsId>>> = ({ signal }) => getDatasetGroupsId(id,params, signal);
...
export const useGetDatasetGroupsId = <TData = Awaited<ReturnType<typeof getDatasetGroupsId>>, TError = ErrorType<Error>>(
 id: number,
    params?: GetDatasetGroupsIdParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getDatasetGroupsId>>, TError, TData>, }
...
export const putDatasetGroupsId = (
    ...
    datasetGroupRequest: DatasetGroupRequest,
      ...
      return API<DatasetGroupResponse>(
      {url: `/dataset-groups/${id}`, method: 'put',
      headers: {'Content-Type': 'application/json', },
      data: datasetGroupRequest
    },
      );
...
export const getPutDatasetGroupsIdMutationOptions = <TError = ErrorType<Error>,
    
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof putDatasetGroupsId>>, TError,{id: number;data: DatasetGroupRequest}, TContext>, }
 ...
 const {mutation: mutationOptions} = options ?? {};
   ...
   return  { mutationFn, ...mutationOptions }}
    ...
    export const usePutDatasetGroupsId = <TError = ErrorType<Error>,
    ...
    id: number,
      ...
      return API<number>(
      {url: `/dataset-groups/${id}`, method: 'delete'
    },
      );
    }
...
export const getDeleteDatasetGroupsIdMutationOptions = <TError = ErrorType<Error>,
    
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteDatasetGroupsId>>, TError,{id: number}, TContext>, }
 ...
 const {mutation: mutationOptions} = options ?? {};
   ...
   return  { mutationFn, ...mutationOptions }}
    ...
    export const useDeleteDatasetGroupsId = <TError = ErrorType<Error>,
